...
def index(request):
    ...
    if request.method=="POST":
        if request.user.is_authenticated: #! kullanıcının girişli olup olmadığını kontrol eder
...
api_key = 'sandbox-DsmFNgz6BPQt7wvpSbq7H8zXIo4clZuQ'
secret_key = 'sandbox-WYRr3ug0dSuGtEJy7L5Dozmbak6jV9MY'
...
def payment(request):
    ...
    request={
        ...
        'price': '1',  #todo: basket price deki price lerın toplamı olmalı
        'paidPrice':userpay.totalPrice,
        'currency': 'TRY',
        'basketId': 'B67832',
        'paymentGroup': 'PRODUCT',
        "callbackUrl": "http://127.0.0.1:8000/result/", #todo:sayfa urlsi öncesinde include de birşey varsa .../result olmalı
